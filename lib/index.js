      ...
      case UNDOSTR:
        {
          ...
          var newPresent = _.cloneDeep(present);
          ...
          return {
            past: newPast,
            present: Array.isArray(newPresent) ? newPresent["".concat(WRAPKEY)] : newPresent,
      ...
      case REDOSTR:
        {
          ...
          var _newPresent = _.cloneDeep(present);
          ...
          return {
            ...
            present: Array.isArray(_newPresent) ? _newPresent["".concat(WRAPKEY)] : _newPresent,
            future: newFuture
          };
        }
